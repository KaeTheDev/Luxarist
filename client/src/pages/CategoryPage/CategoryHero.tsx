  ...
  return (
    <section className="relative w-full h-[60vh] min-h-112.5 flex items-center overflow-hidden bg-black">
      ...
      >
        ...
        {/* Gradient responsive logic maintained */}
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-12 lg:px-20">
        {/* Alignment Logic: 
            ...
            - On Tablet/Desktop: Centered if isShopAll, Left-aligned if Category
        */}
        <div className={`max-w-xl mx-auto ${isShopAll ? "text-center" : "md:mx-0 md:text-left text-center"}`}>
          
          {/* Breadcrumbs: Only show on specific category pages */}
          {!isShopAll && (
          ...
          {/* Description */}
          <p className={`text-white/80 max-w-sm text-sm md:text-base leading-relaxed mb-8 font-light mx-auto ${isShopAll ? "" : "md:mx-0"}`}>
            {description}
          </p>

          {/* Meta Info: using itemLabel and Meta block */}
          <div className={`flex flex-col items-center ${isShopAll ? "md:items-center" : "md:items-start"}`}>
