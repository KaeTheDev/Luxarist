...
import { LayoutDashboard, ShoppingBag, Users, Settings, Package, LogOut, Heart, ChevronRight } from "lucide-react";
...
<div className="flex h-screen bg-white text-stone-900 overflow-hidden font-sans">
            {/* 1. SIDEBAR */}
            <aside className="w-72 border-r border-stone-100 flex flex-col bg-white z-20">
                <div className="p-10">
                ...
                <div className="p-8 border-t border-stone-50">
                    <button className="flex items-center gap-4 px-5 py-4 w-full text-stone-400 hover:text-red-500 transition-colors group">
                ...
                <header className="h-24 flex items-center justify-between px-16 bg-white/70 backdrop-blur-xl sticky top-0 z-10 border-b border-stone-50">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="text-right hidden sm:block">
                            <p className="text-[10px] font-black uppercase tracking-widest text-stone-900">Member Session</p>
                            <p className="text-[8px] text-stone-400 uppercase tracking-[0.2em] mt-0.5">{role} access</p>
                        </div>
                        <div className="w-11 h-11 rounded-full bg-stone-100 border border-stone-200 flex items-center justify-center text-stone-300 overflow-hidden">
                             {/* Placeholder for User Initials or Avatar */}
                             <span className="text-xs font-serif italic">L</span>
                        </div>
                    </div>
                </header>

                {/* The "Stage" where Admin/Customer views appear */}
